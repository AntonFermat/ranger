...
public class UsernamePasswordToken {
	...
	public static UsernamePasswordToken parseToken(RestRequest request) {
		...
		List<String> authStrings = headers.get(BASIC_AUTH_HEADER);
		if (CollectionUtils.isEmpty(authStrings)) {
			return null;
		}

		String authStr = authStrings.get(0);
		...
		try {
			...
			throw new OpenSearchStatusException("Error: Failed to parse user authentication.",
